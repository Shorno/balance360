                        ...
                        <Card className="bg-gray-800/50 border-gray-700">
                            <CardContent className="p-6">
                                <div className="flex flex-col items-center justify-center py-12">
                                    <h2 className="text-2xl font-semibold text-white mb-2">No Trainer Booked</h2>
                                    <p className="text-gray-400 text-center">You haven't booked any trainer yet. Book a
                                        trainer to get started with your fitness journey.</p>
                                </div>
                            </CardContent>
                        </Card>
                    </div>
