                ...
                <div className="relative">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 min-h-[350px]">
                        {visibleReviews.map((review :any, index:number) => (
                            <div
                                ...
                                className={cn(
                                    "bg-gray-800/50 rounded-xl p-6 border border-purple-500/20",
                                    "backdrop-blur-sm transform transition-all hover:scale-[1.02]",
                                    "hover:border-purple-500/40 relative h-full"
                                )}
                            >
                                ...
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div className="flex-1">
                                        <h4 className="text-white font-semibold truncate">{review.user.name}</h4>
                                ...
                                <p className="text-gray-300 leading-relaxed line-clamp-6 mb-4">
                                    {review.comment}
                                </p>
                    ...
                    {allReviews.length > 3 && (
                        <div className="flex justify-center mt-8 gap-4">
                            <button
                                onClick={prev}
                                className="p-2 rounded-full bg-gray-800/50 border border-purple-500/20 text-purple-400 hover:text-purple-300 hover:border-purple-500/40 transition-colors"
                            >
