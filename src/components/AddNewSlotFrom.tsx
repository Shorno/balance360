...
import { type AddNewSlotFormData, addNewSlotSchema, type TrainerFormData } from "@/schema/schema.ts"
...
export default function AddNewSlotForm() {
    ...
    const classOptions =
        (classList?.map((classItem: { id: string; name: string }) => ({
    ...
    return (
        <div className="mt-32 py-8 sm:px-6 lg:px-8">
                        ...
                        {isLoading ? (
                            ...
                            <div className="lg:col-span-1">
                                <div className="sticky top-8 space-y-6 h-full flex flex-col">
                                    <div className="bg-gray-100 dark:bg-gray-800/50 rounded-lg p-6 border border-gray-200 dark:border-gray-700 flex-grow">
                                        <div className="flex items-center md:flex-col space-x-4 mb-6">
                                            ...
                                            />
                                            <div className={""}>
                                                <h3 className="md:text-lg lg:text-center xl:text-lg font-semibold text-gray-900 dark:text-white">
                                        ...
                                        <div className="space-y-6">
                                            <div>
                                                <h4 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Skills</h4>
                                                <div className="flex flex-wrap gap-2">
                                                    {trainerInfo?.skills.map((skill) => (
                                                        <Badge
                                                            key={skill}
                                                            className="bg-purple-100 text-purple-800 dark:bg-purple-500/20 dark:text-purple-300 border border-purple-200 dark:border-purple-500/30"
                                                        >
                                                            {skill}
                                                        </Badge>
                                                    ))}
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-700 dark:text-gray-300">{trainerInfo?.availableTime}</p>
                                ...
                                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                                                ...
                                                <FormItem>
                                                    <FormLabel className="text-gray-700 dark:text-gray-200">
                                                        <div className="flex items-center gap-2">
                                                            <SaveIcon className="w-4 h-4 text-purple-600 dark:text-purple-400" />
                                                            Slot Name
                                                        </div>
                                                    </FormLabel>
                                                    <FormControl>
                                            ...
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Select
                                                        ...
                                                        value={availableDayOptions.filter((option) => value?.includes(option.value))}
                                    ...
                                    <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                                        <Button
                                            disabled={isPending}
                                            type="submit"
                                            className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 dark:from-purple-500 dark:to-pink-500 dark:hover:from-purple-600 dark:hover:to-pink-600 text-white text-lg font-semibold rounded-lg transition-all duration-200 transform hover:scale-[1.02]"
                                        >
                                            {isPending ? (
                                                <div>
                                                    <Dumbbell className="animate-spin mr-2 inline-block" /> Adding Slot...
                                                </div>
                                            ) : (
                                                "Add Slot"
                                            )}
