...
export default function TrainerCard({trainer}: { trainer: TrainerInfoDetails }) {
    return (
        <Card
            key={trainer._id}
            className="bg-white dark:bg-gray-800/50 border-gray-200 dark:border-gray-700 hover:border-purple-500/50 transition-all duration-300 group shadow-sm dark:shadow-none h-full"
        >
            <CardContent className="p-0 flex flex-col h-full">
                ...
                <div className="p-6 flex flex-col flex-grow">
                    ...
                    <Link to={`/trainers/${trainer._id}`} className="mt-6">
                        <Button
